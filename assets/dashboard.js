...
$("#print").click(function(){
	...
	options = {
		...
		html2canvas: { scale: 2, useCORS: true, scrollY: 0, width: 1600, windowWidth: 1600, onclone: function(clonedDoc) { const clonedEle = $("#dashboard")[0]; clonedEle.style.width = '1600px', clonedEle.style.maxWidth = 'none', clonedEle.style.display = 'flex', clonedEle.style.flexWrap = 'nowrap' } },
