...
$("#print").click(function(){
	options = { margin: 0, filename: 'Smart Metering Statistics.pdf', image: { type: 'jpeg', quality: 0.95 }, html2canvas: { scale: 2, useCORS: true, scrollY: 0, scrollX: 0, width: 1600, windowWidth: 1600 }, pagebreak: { mode: ['avoid-all', 'css']}, jsPDF: { unit: 'px', format: 'A4', orientation: 'portrait' } };
